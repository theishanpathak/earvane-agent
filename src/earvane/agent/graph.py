...
from earvane.agent.nodes.reranker import reranker_node
from earvane.agent.nodes.synthesizer import synthesizer_node
...
if __name__ == "__main__":
    graph = build_graph()
    result = graph.invoke(ArtistState(artist_id=4, artist_name="Olivia Rodrigo"))
    print(result)
